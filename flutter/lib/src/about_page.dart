...
class AboutPage extends StatelessWidget {
  ...
  final TextStyle _text = TextStyle(color: Colors.white70);

  final TextStyle _highlight = TextStyle(fontWeight: FontWeight.bold, color: Colors.white);

  MarkdownStyleSheet _buildMarkdownStyle() {
    return MarkdownStyleSheet(a: _highlight, p: _text, strong: _highlight, blockSpacing: 30.0);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(padding: EdgeInsets.all(75.0), children: <Widget>[
          _buildMarkdown('''Version\n__$_verNumber __\n
