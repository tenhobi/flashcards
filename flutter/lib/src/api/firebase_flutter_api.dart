...
class FirebaseFlutterApi extends FirebaseApi {
  ...
  void addSubsection({@required SubsectionType type, @required SubsectionData subsection}) {
    ...
    Firestore.instance
      ...
      .collection(tp).add(subsection.toMap());
  }
  ...
  void editSection(SectionData section) {
	  Firestore.instance.collection('courses').document(section.parent.id).collection('sections').document(section.id).setData(section.toMap());
  }
