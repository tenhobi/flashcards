				...
				onPressed: () {
					...
					if (form.validate()) {
						...
						if(widget.original is ExerciseData) {
							data = ExerciseData(_name, _order, widget.original.parent, widget.original.id);
							state.sectionListBloc.editSubsection.add(Tuple2<SubsectionType, SubsectionData>(SubsectionType.exercise, data));
						} else {
							data = MaterialData(_name, _order, widget.original.parent, widget.original.id);
							state.sectionListBloc.editSubsection.add(Tuple2<SubsectionType, SubsectionData>(SubsectionType.material, data));
						}
